...
# ----------------------------------------------------------------
par(lwd=2);
plot(x=xxx,y=c_WP_PO,type="l",lwd=1,ylim=c(-1,1),col="black",xaxt="n",yaxt="n",
     xlab="",ylab="",cex.lab=2,cex.axis=1.5, lty="solid");
axis(side=4,at=c(-1,-0.5,0,0.5,1), cex.axis=1.5);
points(x=xxx,y=c_WP_EP,type="l",lwd=1,col="green",lty="solid");
points(x=xxx,y=c_PO_EP,type="l",lwd=1,col="orange",lty="solid");
abline(h=0,lwd="0.8",lty="dotted");
