...
cairo_ps("figures/poly_costs.eps",family="Arial",height=8,width=5.5);
par(mfrow=c(4,2),oma=c(5,5,2,1), mar=c(0.5,0.5,0.5,0.5));
# XXX -----> TODO: CHANGE THE BELOW to P00 text.
# ------------------------------------------------------------------------#
evo_cc_02 <- read.table(file="results/fig1/evo_M00_P00_F00_ko.txt", header=FALSE);
evB <- evo_cc_02[evo_cc_02[,3]==0 & evo_cc_02[,4]==0.00 & evo_cc_02[,5]==0,];
...
evB <- evo_cc_02[evo_cc_02[,3]==0 & evo_cc_02[,4]==0.0025 & evo_cc_02[,5]==0,];
evo <- evB[evB[,2]==beta_val,];
mWP <- tapply(X=evo[,7],INDEX=evo[,6],FUN=mean);
mPO <- tapply(X=evo[,8],INDEX=evo[,6],FUN=mean);
mEP <- tapply(X=evo[,9],INDEX=evo[,6],FUN=mean);
...
evB <- evo_cc_02[evo_cc_02[,3]==0 & evo_cc_02[,4]==0.005 & evo_cc_02[,5]==0,];
evo <- evB[evB[,2]==beta_val,];
mWP <- tapply(X=evo[,7],INDEX=evo[,6],FUN=mean);
mPO <- tapply(X=evo[,8],INDEX=evo[,6],FUN=mean);
mEP <- tapply(X=evo[,9],INDEX=evo[,6],FUN=mean);
...
mtext("No post-copulatory choice \t Post-copulatory choice",
	outer=TRUE,side=3,line=0.05,cex=1);
rm(evo_cc_02);
# ------------------------------------------------------------------------#
dev.off();
...
# XXX XXX XXX XXX XXX XXX XXX XXX XXX XXX XXX XXX XXX XXX XXX XXX #
# XXX XXX      PLOT FIGURE 3  XXX XXX XXX XXX XXX XXX XXX XXX XXX #
# XXX XXX XXX XXX XXX XXX XXX XXX XXX XXX XXX XXX XXX XXX XXX XXX #

setEPS(); # postscript below for final publication?
cairo_ps("figures/rel_costs.eps",family="Arial",height=6,width=5.5);
par(mfrow=c(2,2),oma=c(5,5,1,1), mar=c(0.5,0.5,0.5,0.5));
# ------------------------------------------------------------------------#
evo_cc_02 <- read.table(file="results/fig2/evo_M02_P00_Ff0.txt", header=FALSE);
...
rm(evo_cc_02);
# ------------------------------------------------------------------------#
evo_cc_02 <- read.table(file="results/fig2/evo_Mf0_P00_F02.txt", header=FALSE);
...
# XXX XXX XXX XXX XXX XXX XXX XXX XXX XXX XXX XXX XXX XXX XXX XXX #
# XXX XXX      PLOT FIGURE 4  XXX XXX XXX XXX XXX XXX XXX XXX XXX #
# XXX XXX XXX XXX XXX XXX XXX XXX XXX XXX XXX XXX XXX XXX XXX XXX #

setEPS(); # postscript below for final publication?
cairo_ps("figures/fixed_adapt.eps",family="Arial",height=6,width=5.5);
par(mfrow=c(2,2),oma=c(5,5,1,1), mar=c(0.5,0.5,0.5,0.5));
# ------------------------------------------------------------------------#
evo_cc_02 <- read.table(file="results/fig3_new/evo_M00_Pf1_Ff-10.txt", header=FALSE);
...
# XXX XXX XXX XXX XXX XXX XXX XXX XXX XXX XXX XXX XXX XXX XXX XXX #
# XXX XXX FULL FACTORIAL FIGURE OF ALL COSTS  XXX XXX XXX XXX XXX #
# XXX XXX XXX XXX XXX XXX XXX XXX XXX XXX XXX XXX XXX XXX XXX XXX #
...
evo <- evB[evB[,2]==beta_val,]; 
evo <- evo[evo[,1]!=289106184,]; # Got 39 out of this one.
c_WP_PO <- rep(x=0, times=gens);
c_WP_EP <- rep(x=0, times=gens);
c_PO_EP <- rep(x=0, times=gens);
for(i in 0:gens){ # XXX XXX  NOTE: THIS LOOP TAKES A LONG TIME TO RUN XXX #
...
# ------------------------------------------------------------------------#
setEPS(); # postscript below for final publication?
cairo_ps("figures/SI_M00_P02_E02.eps",family="Arial",height=7,width=7.5);
par(mfrow=c(2,2),oma=c(5,5,1,4), mar=c(0.5,0.5,0.5,0.5),lwd=1);
# ----------------------------------------------------------------
mPo <- tapply(X=evo[,8],INDEX=evo[,6],FUN=mean);
plot(x=xxx,y=mPo,type="l",lwd=2,ylim=c(-50,30),col="red",xaxt="n",
...
# ------------------------------------------------------------------------#
setEPS(); # postscript below for final publication?
cairo_ps("figures/SI_M02_P02_E02.eps",family="Arial",height=7,width=7.5);
par(mfrow=c(2,2),oma=c(5,5,1,4), mar=c(0.5,0.5,0.5,0.5),lwd=1);
# ----------------------------------------------------------------
mPo <- tapply(X=evo[,8],INDEX=evo[,6],FUN=mean);
plot(x=xxx,y=mPo,type="l",lwd=2,ylim=c(-50,30),col="red",xaxt="n",
...
# XXX XXX XXX XXX XXX XXX XXX XXX XXX XXX XXX XXX XXX XXX XXX XXX #
# XXX SI ADDRESSING REVIEWER COST COMMENT (Costs 01 & 02)     XXX #
# XXX XXX XXX XXX XXX XXX XXX XXX XXX XXX XXX XXX XXX XXX XXX XXX #
setEPS(); # postscript below for final publication?
cairo_ps("figures/rel_costs_01_02.eps",family="Arial",height=6,width=5.5);
par(mfrow=c(2,2),oma=c(5,5,1,1), mar=c(0.5,0.5,0.5,0.5));
# ------------------------------------------------------------------------#
evo_cc_02 <- read.table(file="results/fig2/evo_M02_P00_Ff0.txt", header=FALSE);
evB <- evo_cc_02[evo_cc_02[,3]==0.02 & evo_cc_02[,4]==0 & evo_cc_02[,5]==0,];
...
rm(evo_cc_02);
# ------------------------------------------------------------------------#
evo_cc_02 <- read.table(file="results/fig2/evo_M02_P00_F01.txt", header=FALSE);
evB <- evo_cc_02[evo_cc_02[,3]==0.02 & evo_cc_02[,4]==0 & evo_cc_02[,5]==0.01,];
evo <- evB[evB[,2]==beta_val,]; 
mWP <- tapply(X=evo[,7],INDEX=evo[,6],FUN=mean);
mPO <- tapply(X=evo[,8],INDEX=evo[,6],FUN=mean);
mEP <- tapply(X=evo[,9],INDEX=evo[,6],FUN=mean);
...
points(x=xxx,y=mWP,type="l",lwd=2,col="blue");
abline(h=0,lwd=0.8,lty="dotted");
text(x=-300, y=-18.0, label=expression(paste(c[F]==0.01)),cex=1.5, pos=4);
text(x=-300, y=-23.0, label=expression(paste(c[M]==0.02)),cex=1.5, pos=4);
#text(x=0, y=-21.0, label=expression(paste(c[P]==0.00)),cex=1, pos=4);
#text(x=0, y=-24.0, label=expression(paste(c[F]==0.00)),cex=1, pos=4);
text(x=-300, y=11.0, label="B", cex=2, pos=4);
...
rm(evo_cc_02);
# ------------------------------------------------------------------------#
evo_cc_02 <- read.table(file="results/fig2/evo_M01_P00_F02.txt", header=FALSE);
evB <- evo_cc_02[evo_cc_02[,3]==0.01 & evo_cc_02[,4]==0 & evo_cc_02[,5]==0.02,];
evo <- evB[evB[,2]==beta_val,]; 
mWP <- tapply(X=evo[,7],INDEX=evo[,6],FUN=mean);
mPO <- tapply(X=evo[,8],INDEX=evo[,6],FUN=mean);
mEP <- tapply(X=evo[,9],INDEX=evo[,6],FUN=mean);
...
#text(x=0, y=-18.0, label=expression(paste(c[M]==0.00)),cex=1, pos=4);
#text(x=0, y=-21.0, label=expression(paste(c[P]==0.00)),cex=1, pos=4);
text(x=-300, y=-18.0, label=expression(paste(c[M]==0.01)),cex=1.5, pos=4);
text(x=-300, y=-23.0, label=expression(paste(c[F]==0.02)),cex=1.5, pos=4);
text(x=-300, y=11.0, label="D", cex=2, pos=4);
rm(evo_cc_02);
# ------------------------------------------------------------------------#
...
# XXX XXX XXX XXX XXX XXX XXX XXX XXX XXX XXX XXX XXX XXX XXX XXX #
# XXX ZOOMING IN ON PANEL D                                   XXX #
# XXX XXX XXX XXX XXX XXX XXX XXX XXX XXX XXX XXX XXX XXX XXX XXX #
setEPS(); # postscript below for final publication?
cairo_ps("figures/rel_costs_01D.eps",family="Arial",height=6,width=5.5);
...
xxx <- tapply(X=evo[,6],INDEX=evo[,6],FUN=mean);
len <- dim(evo)[1];
plot(x=xxx,y=mWP,type="l",lwd=2,ylim=c(-4,1.5),col="blue",xaxt="n",yaxt="n",
     xlab=expression(paste("Generation")),
     ylab=expression(paste("Mean allele value")),
...
points(x=xxx,y=mWP,type="l",lwd=2,col="blue");
abline(h=0,lwd=0.8,lty="dotted");
axis(side=2,at=c(-4,-3,-2,-1,0,1), cex.axis=1.5);
axis(side=1,at=c(0,10000,20000,30000), cex.axis=1.5);
#text(x=0, y=-18.0, label=expression(paste(c[M]==0.00)),cex=1, pos=4);
#text(x=0, y=-21.0, label=expression(paste(c[P]==0.00)),cex=1, pos=4);
text(x=-300, y=-18.0, label=expression(paste(c[M]==0.01)),cex=1.5, pos=4);
text(x=-300, y=-23.0, label=expression(paste(c[F]==0.02)),cex=1.5, pos=4);
text(x=-300, y=1.35, label="D", cex=5, pos=4);
rm(evo_cc_02);
# ------------------------------------------------------------------------#
dev.off();
...
# XXX XXX XXX XXX XXX XXX XXX XXX XXX XXX XXX XXX XXX XXX XXX XXX #
# XXX AGAIN ZOOMING IN ON PANEL D                             XXX #
# XXX XXX XXX XXX XXX XXX XXX XXX XXX XXX XXX XXX XXX XXX XXX XXX #
setEPS(); # postscript below for final publication?
cairo_ps("figures/rel_costs_01D2.eps",family="Arial",height=6,width=5.5);
par(mfrow=c(1,1), mar=c(6,5,1,1));
# ------------------------------------------------------------------------#
evo_cc_02 <- read.table(file="results/fig2/evo_M01_P00_F02.txt", header=FALSE);
evB <- evo_cc_02[evo_cc_02[,3]==0.01 & evo_cc_02[,4]==0 & evo_cc_02[,5]==0.02,];
...
xxx <- tapply(X=evo[,6],INDEX=evo[,6],FUN=mean);
len <- dim(evo)[1];
plot(x=xxx,y=mWP,type="l",lwd=2,ylim=c(-1.5,1.5),col="blue",xaxt="n",yaxt="n",
     xlab=expression(paste("Generation")),
     ylab=expression(paste("Mean allele value")),
     cex.lab=2,cex.axis=1.5);
points(x=xxx,y=mPO,type="l",lwd=2,col="red");
...
# XXX XXX XXX XXX XXX XXX XXX XXX XXX XXX XXX XXX XXX XXX XXX XXX #
# XXX SI ADDRESSING REVIEWER COST COMMENT (Costs 01 & 03)     XXX #
# XXX XXX XXX XXX XXX XXX XXX XXX XXX XXX XXX XXX XXX XXX XXX XXX #
setEPS(); # postscript below for final publication?
cairo_ps("figures/rel_costs_01_03.eps",family="Arial",height=6,width=5.5);
par(mfrow=c(2,2),oma=c(5,5,1,1), mar=c(0.5,0.5,0.5,0.5));
# ------------------------------------------------------------------------#
evo_cc_02 <- read.table(file="results/fig2/evo_M03_P00_Ff0.txt", header=FALSE);
evB <- evo_cc_02[evo_cc_02[,3]==0.03 & evo_cc_02[,4]==0 & evo_cc_02[,5]==0.01,];
evo <- evB[evB[,2]==beta_val,]; 
mWP <- tapply(X=evo[,7],INDEX=evo[,6],FUN=mean);
mPO <- tapply(X=evo[,8],INDEX=evo[,6],FUN=mean);
mEP <- tapply(X=evo[,9],INDEX=evo[,6],FUN=mean);
...
points(x=1:gens,y=rep(0,length(1:gens)),type="l",lwd=2,col="black");
axis(side=2,at=c(-20,-10,0,10), cex.axis=1.5);
text(x=-300, y=-23.0, label=expression(paste(c[M]==0.03)),cex=1.5, pos=4);
#text(x=0, y=-21.0, label=expression(paste(c[P]==0.00)),cex=1, pos=4);
#text(x=0, y=-24.0, label=expression(paste(c[F]==0.00)),cex=1, pos=4);
text(x=-300, y=11.0, label="A", cex=2, pos=4);
rm(evo_cc_02);
# ------------------------------------------------------------------------#
evo_cc_02 <- read.table(file="results/fig2/evo_M03_P00_F01.txt", header=FALSE);
evB <- evo_cc_02[evo_cc_02[,3]==0.03 & evo_cc_02[,4]==0 & evo_cc_02[,5]==0.01,];
evo <- evB[evB[,2]==beta_val,]; 
mWP <- tapply(X=evo[,7],INDEX=evo[,6],FUN=mean);
mPO <- tapply(X=evo[,8],INDEX=evo[,6],FUN=mean);
...
rm(evo_cc_02);
# ------------------------------------------------------------------------#
evo_cc_02 <- read.table(file="results/fig2/evo_Mf0_P00_F03.txt", header=FALSE);
evB <- evo_cc_02[evo_cc_02[,3]==0.01 & evo_cc_02[,4]==0 & evo_cc_02[,5]==0.03,];
evo <- evB[evB[,2]==beta_val,]; 
mWP <- tapply(X=evo[,7],INDEX=evo[,6],FUN=mean);
mPO <- tapply(X=evo[,8],INDEX=evo[,6],FUN=mean);
mEP <- tapply(X=evo[,9],INDEX=evo[,6],FUN=mean);
...
#text(x=0, y=-18.0, label=expression(paste(c[M]==0.00)),cex=1, pos=4);
#text(x=0, y=-21.0, label=expression(paste(c[P]==0.00)),cex=1, pos=4);
text(x=-300, y=-23.0, label=expression(paste(c[F]==0.03)),cex=1.5, pos=4);
text(x=-300, y=11.0, label="C", cex=2, pos=4);
rm(evo_cc_02);
# ------------------------------------------------------------------------#
evo_cc_02 <- read.table(file="results/fig2/evo_M01_P00_F03.txt", header=FALSE);
evB <- evo_cc_02[evo_cc_02[,3]==0.01 & evo_cc_02[,4]==0 & evo_cc_02[,5]==0.03,];
evo <- evB[evB[,2]==beta_val,]; 
mWP <- tapply(X=evo[,7],INDEX=evo[,6],FUN=mean);
mPO <- tapply(X=evo[,8],INDEX=evo[,6],FUN=mean);
