...
{%
   \includegraphics[height=13.5cm]{figures/rel_costs.pdf}%
}%
\end{adjustwidth}
}
...
\mysidecaption{0.70}
{%
   \includegraphics[height=13.5cm]{figures/fixed_adapt.pdf}%
}
{%
...
This work was funded by a European Research Council Starting Grant to JMR. Computer simulations were performed using the Maxwell Computing Cluster at the University of Aberdeen. We thank Matthew E. Wolak for very helpful comments on this manuscript.
