...
% ==================================================================================================
\bibitem[{Kuriwada et~al.(2011)Kuriwada, Kumano, Shiromoto, and
  Haraguchi}]{Kuriwada2011}
Kuriwada, T., N.~Kumano, K.~Shiromoto, and D.~Haraguchi. 2011.
...
\newblock Behavioral Ecology and Sociobiology 65:1483--1489.
...
\newblock Genetical Research 36:221--235.

\bibitem[{Lehtonen and Kokko(2015)}]{Lehtonen2015}
Lehtonen, J., and H.~Kokko. 2015.
\newblock {Why inclusive fitness can make it adaptive to produce less fit
  extra-pair offspring}.
\newblock Proceedings of the Royal Society B 282:20142716.

\bibitem[{Levin and Lubchenco(2008)}]{Levin2008}
Levin, S.~A., and J.~Lubchenco. 2008.
\newblock {Resilience, robustness, and marine ecosystem-based management}
  58:27--32.

\bibitem[{Lihoreau et~al.(2007)Lihoreau, Zimmer, and Rivault}]{Lihoreau2007}
Lihoreau, M., C.~Zimmer, and C.~Rivault. 2007.
\newblock {Kin recognition and incest avoidance in a group-living insect}.
\newblock Behavioral Ecology 18:880--887.

\bibitem[{Liu et~al.(2014)Liu, Tu, He, Chen, and Xue}]{Liu2014}
Liu, X., X.~Tu, H.~He, C.~Chen, and F.~Xue. 2014.
\newblock {Evidence for inbreeding depression and pre-copulatory, but not post
  copulatory inbreeding avoidance in the cabbage beetle Colaphellus bowringi.}
\newblock PloS one 9:e94389.

\bibitem[{Lynch and Walsh(1998)}]{Lynch1998}
Lynch, M., and B.~Walsh. 1998.
\newblock {Genetics and Analysis of Quantitative Traits}.
\newblock Sinauer, Sunderland.

\bibitem[{Metzger et~al.(2010{\natexlab{\emph{a}}})Metzger, Bernstein,
  Hoffmeister, and Desouhant}]{Metzger2010}
Metzger, M., C.~Bernstein, T.~S. Hoffmeister, and E.~Desouhant.
  2010{\natexlab{\emph{a}}}.
\newblock {Does kin recognition and sib-mating avoidance limit the risk of
  genetic incompatibility in a parasitic wasp?}
\newblock PLoS One 5:1--6.

\bibitem[{Metzger et~al.(2010{\natexlab{\emph{b}}})Metzger, Fischbein, Auguste,
  Fauvergue, Bernstein, and Desouhant}]{Metzger2010a}
Metzger, M., D.~Fischbein, A.~Auguste, X.~Fauvergue, C.~Bernstein, and
  E.~Desouhant. 2010{\natexlab{\emph{b}}}.
\newblock {Synergy in information use for mate finding: Demonstration in a
  parasitoid wasp}.
\newblock Animal Behaviour 79:1307--1315.

\bibitem[{Mills and Smouse(1994)}]{Mills1994}
Mills, L.~S., and P.~E. Smouse. 1994.
\newblock {Demographic consequences of inbreeding in remnant populations}.
\newblock American Naturalist 144:412--431.

\bibitem[{Morton et~al.(1956)Morton, Crow, and Muller}]{Morton1956}
...
\bibitem[{Nowak et~al.(1997)Nowak, Boerlijst, Cooke, and {Maynard
  Smith}}]{Nowak1997}
...
\bibitem[{Pizzari et~al.(2004)Pizzari, L{\o}vlie, and Cornwallis}]{Pizzari2004}
...
\bibitem[{Potts et~al.(1991)Potts, Manning, and Wakeland}]{Potts1991}
...
\newblock Genetical Research 75:83--94.
...
\newblock Behavioral Ecology 00:1--2.

\bibitem[{Reid et~al.(2015{\natexlab{\emph{a}}})Reid, Arcese, Keller, Germain,
  Duthie, Losdat, Wolak, and Nietlisbach}]{Reid2014}
Reid, J.~M., P.~Arcese, L.~F. Keller, R.~R. Germain, A.~B. Duthie, S.~Losdat,
  M.~E. Wolak, and P.~Nietlisbach. 2015{\natexlab{\emph{a}}}.
\newblock {Quantifying inbreeding avoidance through extra-pair reproduction}.
\newblock Evolution 69:59--74.

\bibitem[{Reid et~al.(2015{\natexlab{\emph{b}}})Reid, Duthie, Wolak, and
  Arcese}]{Reid2015}
Reid, J.~M., A.~B. Duthie, M.~E. Wolak, and P.~Arcese.
  2015{\natexlab{\emph{b}}}.
\newblock {Demographic mechanisms of inbreeding adjustment through extra-pair
  reproduction}.
\newblock Journal of Animal Ecology 84:1029--1040.

\bibitem[{Roberts et~al.(2015)Roberts, Evison, Baer, and Hughes}]{Roberts2015a}
Roberts, K.~E., S.~E.~F. Evison, B.~Baer, and W.~O.~H. Hughes. 2015.
\newblock {The cost of promiscuity: sexual transmission of Nosema
  microsporidian parasites in polyandrous honey bees}.
\newblock Scientific Reports 5:10982.

\bibitem[{Roff(1996)}]{Roff1996}
Roff, D.~A. 1996.
\newblock {The evolution of threshold traits in animals}.
\newblock The Quarterly Review of Biology 71:3--35.
...
\newblock Heredity 80:25--32.

\bibitem[{Ronkainen and Ylonen(1994)}]{Ronkainen1994}
Ronkainen, H., and H.~Ylonen. 1994.
\newblock {Behaviour of cyclic bank voles under risk of mustelid predation: Do
  females avoid copulations?}
\newblock Oecologia 97:377--381.

\bibitem[{Rowe(1988)}]{Rowe1988}
Rowe, L. 1988.
\newblock {Cost of mating for female insects: risk of predation in Photinus
  collustrans (Coleoptera: Lampyridae)}.
\newblock American Naturalist 121:139--142.

\bibitem[{Rowe et~al.(1994)Rowe, Arnqvist, Sih, and Krupa}]{Rowe1994}
Rowe, L., G.~Arnqvist, A.~Sih, and J.~J. Krupa. 1994.
\newblock {Sexual conflict and the evolutionary ecology of mating patterns:
  water striders as a model system}.
\newblock Trends in Ecology {\&} Evolution 9:289--293.

\bibitem[{Simmons et~al.(2006)Simmons, Beveridge, Wedell, and
  Tregenza}]{Simmons2006}
Simmons, L.~W., M.~Beveridge, N.~Wedell, and T.~Tregenza. 2006.
\newblock {Postcopulatory inbreeding avoidance by female crickets only revealed
  by molecular markers}.
\newblock Molecular Ecology 15:3817--3824.

\bibitem[{Suraci et~al.(2017)Suraci, Clinchy, and Zanette}]{Suraci2017}
Suraci, J.~P., M.~Clinchy, and L.~Y. Zanette. 2017.
\newblock {Do large carnivores and mesocarnivores have redundant impacts on
  intertidal prey?}
\newblock PLoS One 12:e0170255.

\bibitem[{Szulkin et~al.(2013)Szulkin, Stopher, Pemberton, and
  Reid}]{Szulkin2012}
Szulkin, M., K.~V. Stopher, J.~M. Pemberton, and J.~M. Reid. 2013.
\newblock {Inbreeding avoidance, tolerance, or preference in animals?}
\newblock Trends in Ecology {\&} Evolution 28:205--211.

\bibitem[{Tan et~al.(2012)Tan, L{\o}vlie, Pizzari, and Wigby}]{Tan2012}
Tan, C. K.~W., H.~L{\o}vlie, T.~Pizzari, and S.~Wigby. 2012.
\newblock {No evidence for precopulatory inbreeding avoidance in Drosophila
  melanogaster}.
\newblock Animal Behaviour 83:1433--1441.

\bibitem[{Tregenza and Wedell(2002)}]{Tregenza2002}
Tregenza, T., and N.~Wedell. 2002.
\newblock {Polyandrous females avoid costs of inbreeding}.
\newblock Nature 415:71--73.

\bibitem[{Tuni et~al.(2013)Tuni, Beveridge, and Simmons}]{Tuni2013}
Tuni, C., M.~Beveridge, and L.~W. Simmons. 2013.
\newblock {Female crickets assess relatedness during mate guarding and bias
  storage of sperm towards unrelated males}.
\newblock Journal of Evolutionary Biology 26:1261--1268.

\bibitem[{Varian-Ramos and Webster(2012)}]{Varian-Ramos2012}
Varian-Ramos, C.~W., and M.~S. Webster. 2012.
\newblock {Extrapair copulations reduce inbreeding for female red-backed
  fairy-wrens, Malurus melanocephalus}.
\newblock Animal Behaviour 83:857--864.

\bibitem[{Whitacre and Bender(2010)}]{Whitacre2010}
Whitacre, J., and A.~Bender. 2010.
\newblock {Degeneracy: A design principle for achieving robustness and
  evolvability}.
\newblock Journal of Theoretical Biology 263:143--153.

\bibitem[{Whitacre(2010)}]{Whitacre2010a}
Whitacre, J.~M. 2010.
\newblock {Degeneracy: a link between evolvability, robustness and complexity
  in biological systems}.
\newblock Theoretical Biology and Medical Modelling 7:6.

\bibitem[{Zeh and Zeh(1997)}]{Zeh1997}
Zeh, J.~A., and D.~W. Zeh. 1997.
\newblock {The evolution of polyandry II: post-copulatory defenses against
  genetic incompatibility}.
\newblock Proceedings of the Royal Society B 264:69--75.
...
\begin{figure}
\begin{center}				
\includegraphics[scale=0.85]{figures/poly_costs.pdf}
\end{center}
...
\begin{figure}
\begin{center}				
\includegraphics[scale=0.60]{figures/Pp_vals.pdf}
\end{center}
...
\begin{figure}
\begin{center}				
\includegraphics[scale=1.00]{figures/rel_costs.pdf}
\end{center}
...
\begin{figure}
\begin{center}				
\includegraphics[scale=1.00]{figures/fixed_adapt.pdf}
\end{center}
