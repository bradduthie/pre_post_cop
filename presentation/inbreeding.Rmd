...
![](images/beta_slopes.png)

Multi-locus genetic architecture:

- Fixed inbreeding depression for individual *f*
- Allele values at 10 loci increase (positive) or decrease (negative) inbreeding
- Allele values sum additively to determine overall inbreeding behaviour phenotype
...
Make point about inbreeding adjustment given strong constraints

Make point that it's hard to detect through a change in kinship (and subject to bias)

Make point that pre, post and polyandry evolve given strong ID and no costs

Make point that opportunity for post-cop greatly increases polyandry selection

Make point that selection tends to go with the least costly IA route
