...
- What inbreeding depression is, exactly.
...
- Females should prefer inbreeding below their inbreeding depression threshold (resource limited)<footnote content="foot1">[here](http://google.com)</footnote>:
- Males should *tolerate* inbreeding below their threshold, but *never prefer*<footnote content="foot1">[Puurtinen](http://google.com)</footnote> (sis will be fine)
...
```{r IBM_1, fig.show='animate', echo = FALSE, fig.width = 4}
inputPanel(
...
```{r IBM_3, fig.show = 'animate', echo = FALSE}
inputPanel(
...
```{r IBM_2, fig.show = 'animate', echo = FALSE}
inputPanel(
