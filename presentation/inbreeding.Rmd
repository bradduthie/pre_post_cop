...
renderPlot({
  ...
  if(length(gens) < 6){
      plot(x = 0:10, y = 0:10, type = "n", ylim = c(-1, 1), cex.axis = 1.5,
           cex.lab = 1.5, xlab = "Generation", ylab = "Inbreeding strategy", 
           bg = "transparent");
      abline(h = 0, lty = "dotted", lwd = 0.8);
      polygon(x=c(-0.125, 2.5, 2.5, -0.125), y=c(0.825, 0.825, 1.1, 1.1), 
              border=NA, col="black");
      polygon(x=c(-0.125, 2.5, 2.5, -0.125), y=c(-0.825, -0.825, -1.1, -1.1), 
              border=NA, col="black");
      ...
      x0 <- length(gens) - 5;
      x1 <- length(gens) + 5;
      plot(x = x0:x1, y = 0:10, type = "n", ylim = c(-1, 1), cex.axis = 1.5,
           cex.lab = 1.5, xlab = "Generation", ylab = "Inbreeding strategy", 
           bg = "transparent");
      abline(h = 0, lty = "dotted", lwd = 0.8);
      polygon(x=c(x0-0.125, x0+2.5, x0+2.5, x0-0.125), 
