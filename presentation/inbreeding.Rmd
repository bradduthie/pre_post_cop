...
plot(x = 1:10, y = 1:10, xaxt = "n", yaxt = "n", xlab = "", ylab = "");
# Add see-saw function here to animate the balance
```
...
- Females should prefer inbreeding below their inbreeding depression threshold (resource limited)<footnote content="The first awesoem footnote!">here</footnote>:
- Males should *tolerate* inbreeding below their threshold, but *never prefer* (sis will be fine)
