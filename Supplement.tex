...
\end{center}
\caption{Caption for first relative cost: 0.01 and 0.03}
\label{extra_MfPf}
\end{figure}
...
\begin{figure}
\begin{center}				
\includegraphics[scale=0.8]{figures/rel_costs/01_02.png}
\end{center}
\caption{Caption for second relative cost: 0.01 and 0.02}
\label{extra_MfPf}
\end{figure}
